...
X<predefinite; direttive; C<package>>
...
alla variabile C<@scatole> dal namespace C<main> solo col suo nome I<fully
qualified> C<@MioCodice::scatole>. Un nome fully qualified include un
