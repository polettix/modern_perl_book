...
La manutenibilità non è nè un problema sintattico nè una misura di come il vostro codice
...
=item * I<Scegliete con cura i nomi delle entità>. Your code tells a story. Every named
