...
scope lessicale nidificato. L'istruzione predefinita C<no> annulla un'importazione (L<importing>),
...
X<variabili predefinite; C<$^H>>
X<direttive; scrittura>

In Perl 5.10.0 è stata aggiunta la possibilità di scrivere le proprie pragma lessicali in puro codice Perl.
