...
Usate il metacarattere C<\s> per riconoscere la spaziatura, che si tratti di un semplice carattere di spazio, di un carattere di tabulaizone,
...
globale visto prima potrebbe essere reso più robusto nel rimpiazzare tutte le occorrenze del nome
