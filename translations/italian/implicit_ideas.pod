...
Per esempio, la funzione predefinita C<chomp> rimuove una sequenza di "a capo" dalla
fine della stringa dataN<Vedete C<perldoc -f chomp> e C<$/> per maggiori dettagli.>:
...
C<$_> ha lo stesso ruolo in Perl dei pronomi I<ciò>, I<quello> o del suffisso I<-lo> in Italiano. Leggete la prima linea
come se dicesse "C<chomp>-alo" e la seconda come "C<chomp>". Perl capisce a che cosa vi riferite
quando dite "C<chomp>", e farà sempre "chomp" su "quel" valore.
