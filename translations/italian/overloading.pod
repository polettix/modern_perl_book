...
Fare l'overload della conversione a numero è più complesso, perchè gli operatori binari sono genralmente
...
I<nome> di un metodo da chiamare per implementare l'overloading, anzichè
...
ha senso, perchè la notazione esistente per tali operazioni è
