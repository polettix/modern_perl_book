...
Tale valore può essere una stringa, un intero, un numero floating point, un filehandle
...
=begin programlisting
    ...
    # aggiorna sign e restituisci il nuovo valore
    my $next_sign = ++$call_sign;

    # restituisci il vecchio valore, e I<quindi> aggiorna sign
...
Questo magico incremento di stringa non ha un corrispondente
decremento. Non potete ottenere il valore stringa precedente scrivendo C<$call_sign-->.
...
C<$authors> è ancora un riferimento valido, ma C<$stringy_ref> è una stringa
che non ha connessioni con il riferimento e C<$numeric_ref> è un numero che
