...
Quando tentate di scrivere dentro un componente di una struttura dati nidificata, Perl creerà
il cammino necessario nella struttura dati fino alla destinazione:

=begin programlisting

    my @adadada;
    $adadada[0][0][0][0] = 'profondamente nidificato';
