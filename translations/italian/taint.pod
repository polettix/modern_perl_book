...
e comprensione dei problemi aiutandovi ad evitare errori sottili.
...
usare dati matchiati nel vostro programma, ma se li usate in operazioni che hanno effetti sul mondo
...
I dati marchiati hanno due origini: l'input da file input e l'ambiente operativo
...
La variabile globale C<%ENV> rappresenta le variabili d'ambiente del sistema.  Tali
dati sono marchiati poichè i loro valori sono controllati da forze esterne al
...
di sistemi per perpetrare i suoi misfatti.
