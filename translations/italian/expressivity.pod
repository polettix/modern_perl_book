...
leggibilità e alla manutenibilità, specialmente per chi che verrà dopo di voi.

I principianti di Perl spesso trovano che alcuni dei suoi costrutti siano poco comprensibili. Molti di questi idiomi
(L<idioms>) sono estrememente potenti, anche se in modi sottili e non sempre ovvi. Può essere una buona idea evitarli fino a che non
...
si ottiene esercitando sia nella lettura sia nella scrittura. Non dovete conoscere ogni dettaglio di Perl per usarlo in modo produttivo,
...
tratta entrambe le variabili come valori numerici e produce un risultato numerico. Indipendentemente da quale siano i contenuti di
...
Tutti e tre gli approcci portano allo stesso risultato, ma ciascuno sfrutta Perl in modo diverso.
