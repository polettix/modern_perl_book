...
X<hash; C<each>>
X<predefinite; direttive; C<each>>
...
Questa I<manovra orcish>N<NdT: manovra da orchi; in Inglese è un gioco di parole con Or-cache.> restituisce il valore dell'hash,
...
è quasi sempre più accurato. Essendo pigra, la manovra orcish testa la definitezza del valore in cache, non
la sua verità.
