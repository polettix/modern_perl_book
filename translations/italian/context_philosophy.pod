...
=begin programlisting
    ...
    processa_lista_di_risultati( cerca_faccende() );
...
contengono, quindi entrambe queste chiamate a C<cerca_faccende()> sono valutate in contesto lista:
...
=begin programlisting
    ...
    say "Errore catastrofico di crittografia!" if $alice eq $roberto;
...
=begin programlisting
    ...
    my $alice = 'alice';
    say "Errore catastrofico di crittografia!" if $alice == 'Roberto';
