...
comportamento dello scope lessicale chimante anzichè per esportare simboli:
...
I simboli esportati per default vanno elencati in C<@EXPORT> anzichè in
C<@EXPORT_OK>:
...
package con i loro nomi fully-qualified:
...
Perl 5 non vi richiede di usare i moduli, nè i package, nè i namespace. Potete
...
=item * I moduli forniscono un meccanismo di riuso del codice.
