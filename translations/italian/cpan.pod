...
lo ha notevolmente esteso, rendendo poi disponibile a tutti i risultati di questo lavoro.
...
Perl Moderno senza CPAN è solo un linguaggio. Perl Moderno con CPAN è linguaggio incredibile.
...
distribuzioni in una vostra directory personale, anzichè nell'intero sistema.
...
L'installazione è un pó più complicata di quella delle due distribuzioni descritte sopra, ma C<App::local::lib::helper> può renderla più semplice.  Guardate
