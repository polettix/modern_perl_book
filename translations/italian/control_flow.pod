...
In questo codice, ritornare da C<saluta_persona()> direttamente al chiamante di
C<traccia_e_saluta_persona()> è più efficiente che ritornare a
C<traccia_e_saluta_persona()> e poi ritornare immediatamente I<da>
C<traccia_e_saluta_persona()>. Ritornare direttamente da C<saluta_persona()> al
