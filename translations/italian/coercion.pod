...
corrispondenti a tali caratteri e non producono warning; per esempio C<10 leptoni leaping> diventa
C<10> e C<6.022e23 talpe marauding> diventa C<6.022e23>.
...
Anche se l'hash non conteneva valori per C<Brad> e C<Jack>, Perl
...
=begin programlisting
    ...
    say 'Vero come booleano!'  if      !! $false_name;
    say 'Falso come numero!'   unless  0  + $false_name;
    say 'Vero come stringa!'   if     ''  . $false_name;
